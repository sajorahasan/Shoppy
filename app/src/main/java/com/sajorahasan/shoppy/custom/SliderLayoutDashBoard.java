package com.sajorahasan.shoppy.custom;
...
import com.sajorahasan.shoppy.HomeFragment;

import java.lang.reflect.Field;
import java.util.Timer;
import java.util.TimerTask;

public class SliderLayoutDashBoard extends RelativeLayout{
    ...
    public SliderLayoutDashBoard(Context context) {
        this(context,null);
    }

    public SliderLayoutDashBoard(Context context, AttributeSet attrs) {
        this(context,attrs, com.daimajia.slider.library.R.attr.SliderStyle);
    }

    public SliderLayoutDashBoard(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void addOnPageChangeListener(HomeFragment homeFragment) {
