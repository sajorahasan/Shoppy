 ...
 *
 */
public class ProDetailSliderLayout extends RelativeLayout{
    ...
    public ProDetailSliderLayout(Context context) {
        this(context,null);
    }

    public ProDetailSliderLayout(Context context, AttributeSet attrs) {
        this(context,attrs, com.daimajia.slider.library.R.attr.SliderStyle);
    }

    public ProDetailSliderLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void addOnPageChangeListener(ProductDetailActivity mainActivity) {
